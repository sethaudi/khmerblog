<?php
    $article_list = array(
        ...
        "10.1007/s10832-012-9736-1",
        "10.1038/nmat3258",
        "10.1158/1541-7786.MCR-14-0590",
        ...
        "10.1007/978-3-319-28658-7_55",
        "10.1038/nmat1849",
        "10.1038/nbt.2842",
        "10.1038/nphys3430",
        "10.1038/nn.4065",
        "10.1016/j.joen.2009.12.007",
        "10.1038/nature16961",
        "10.1021/acs.jpcc.5b04175",
        ...
        "10.1007/s10858-015-9995-7",
        "10.1016/0927-796X(95)00185-9",
        "10.1038/nature04969",
        "10.1038/nature16549",
        "10.1007/s11886-015-0565-0",
    ...
    foreach($article_list as $article) {
        $article_url = 'http://api.crossref.org/works/'.$article;
        ...
        array_push($data_export, $temp_array);
    }
    sort($data_export);
?>
...
<body>
    <div class="container">
        <button id="top" class="navigation"><a href="#bottom">Bottom</a></button>
        <?php //Sort by publisher, ascending, and descending order ?>
        <!--<div class="sort">
            Sort by publisher<select type="text">
            <?php //foreach($data_export as $data) { ?>
                <option><?php //print $data['publisher']; ?></option>
            <?php //} ?>
            </select>
            Sort by title order<select type="text">
                <option>ASC</option>
                <option>DESC</option>
            </select>
        </div> -->
        <table width="100">
          <tr>
            <th class="header"><center>Article</center></th>
            <th class="header"><center>Publisher</center></th>
          </tr>
          <?php //Displa each article row ?>
          <?php foreach($data_export as $data){ ?>
            <tr>
                <td class='article-col fancy'><a class="link" href="<?php print $data['url']; ?>" target="_blank"><?php print $data['title']; ?></a></td>
                <td class='publisher-col fancy'><?php print $data['publisher']; ?></td>
            </tr>
          <?php } ?>

        </table>
        <button id="bottom" class="navigation"><a href="#top">Top</a></button>
    </div>
